...
#Version: Voronai Iteration Style K-medoid Clustering
...
#Swapping with non-medoid data points - Iterate to do multiple swaps (tuning)
...
for i in range(MSL):
    if ClusterJoin[i][0] == 0:
        ...
        ClusterList.append(ClusterJoin[i][1])
        
ClusterAnalytes = tuple(ClusterList)
...
Chem.Draw.MolsToGridImage(ClusterAnalytes)


#
#Chem.Draw.MolsToGridImage(AnalyteList)
#Dendrogram Clustering
#ytdist = squareform(TDM)
...
#####Filter by further criteria - see below for individual functions (First 10)
...
#Analyte10
#
#AnalyteList = (Analyte1,Analyte2,Analyte3,Analyte4,Analyte5,Analyte6,Analyte7,Analyte8,Analyte9,Analyte10)
#
#
#
#ShaperFull = np.shape(Choke)
...
####Filter by further criteria - see below for individual functions (Beginning, Middle, End: 10 Total)
#Analyte1 = Choke[0][1]
#print('Molecular Weight of Analyte 1:', Chem.Descriptors.ExactMolWt(Analyte1))
#print('Log P Value of Analyte 1:', Chem.Descriptors.MolLogP(Analyte1))
#print('Polar Surface Area of Analyte 1:', Chem.Descriptors.TPSA(Analyte1))
...
#Older Code - Kept for reference purposes
