...
#Tanimoto K-means Clustering

#Selecting 2 clusters
TDM_Kmeans = KMeans(n_clusters=2, random_state=0).fit(TDM)
TDM_Pred = TDM_Kmeans.predict(TDM_Kmeans)
TDM_Kmeans_Labels = TDM_Kmeans.labels_
TDM_Kmeans_Centeroids = TDM_Kmeans.cluster_centers_

#Visualizing the Clusters
#plt.figure()
#plt.scatter(TDM_Kmeans[:,0],TDM_Kmeans[:,1], c= TDM_Pred)
